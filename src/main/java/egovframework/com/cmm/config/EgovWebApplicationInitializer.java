...
import jisungsoft.com.sec.security.filter.SpringSecurityLoginFilter;
import jisungsoft.com.sec.security.filter.SpringSecurityLogoutFilter;
...
public class EgovWebApplicationInitializer implements WebApplicationInitializer {
	...
	public void onStartup(ServletContext servletContext) throws ServletException {
		...
		characterEncoding.addMappingForUrlPatterns(null, false, "*.xml");
...
//		dispatcher.addMapping("/"); // Facebook OAuth 사용시 변경
		...
		if("security".equals(EgovProperties.getProperty("Globals.Auth").trim())) {
			...
			//-------------------------------------------------------------
			FilterRegistration.Dynamic egovSpringSecurityLoginFilter = servletContext.addFilter("egovSpringSecurityLoginFilter", new SpringSecurityLoginFilter());
			//로그인 실패시 반활 될 URL설정
			egovSpringSecurityLoginFilter.setInitParameter("loginURL", Globals.GNR_LOGIN_PAGE);

			egovSpringSecurityLoginFilter.setInitParameter("USRLoginURL", Globals.USR_LOGIN_PAGE);
			//로그인 처리 URL설정
			egovSpringSecurityLoginFilter.setInitParameter("loginProcessURL", "/loginAction.do");
			//처리 Url Pattern
			...
			//-------------------------------------------------------------	
			FilterRegistration.Dynamic egovSpringSecurityLogoutFilter = servletContext.addFilter("egovSpringSecurityLogoutFilter", new SpringSecurityLogoutFilter());
			egovSpringSecurityLogoutFilter.addMappingForUrlPatterns(null, false, "/logoutAction.do");
