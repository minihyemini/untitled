...
/**
 *  Class Name  : NoticeDataController.java
 *  Description : 공지사항 관리 Business class
 *  Menu : CMS > 상담지식관리 > 공지사항
 */
//@Controller
...
//    @Resource(name = "bbsMasterService")
    ...
    public String noticeList(@PathVariable(value="path") String path, @ModelAttribute("articleDataVO") ArticleDataVO articleDataVO,
        ...
        return "jisungsoft/com/" + path + "/cop/bbs/notice/noticeList."+path;
    }

    @RequestMapping("/noticeDetail.do")
    public String noticeDetail(@PathVariable(value="path") String path, @ModelAttribute ArticleDataVO mainVO,
                                ...
                                ModelMap model) throws Exception
    {
        ...
        BbsViewerLogVO bbsViewerLogVO = new BbsViewerLogVO();
        bbsViewerLogVO.setNttId(resultData.getNttId());
        bbsViewerLogVO.setEsntlId(authenticatedUser.getUniqId());
        int i = articleDataService.selectBbsViewerListCnt(bbsViewerLogVO);
        if (i == 0) {
            articleDataService.insertBbsViewer(bbsViewerLogVO);
        }
        ...
        return "jisungsoft/com/" + path + "/cop/bbs/notice/noticeDetail."+path;
    }

    @RequestMapping("/noticeForm.do")
    public String noticeForm(@PathVariable("path") String path, @ModelAttribute ArticleDataVO mainVO,
                                  ModelMap model, @RequestParam(value = "mode") String mode) throws Exception
    {
        ...
        return "jisungsoft/com/" + path + "/cop/bbs/notice/noticeForm."+path;
    }

    @RequestMapping(value = "/noticeInsert.do", method = RequestMethod.POST)
    public String noticeInsert(@ModelAttribute ArticleDataVO articleDataVO,
                                ...
                                ModelMap model) throws Exception
    {
        ...
        model.addAttribute("redirectUri", "/"+path+"/cop/bbs/noticeList.do?bbsId="+bbsId+"&menuId="+commandMap.get("menuId"));
        return "jisungsoft/com/script/alertHref";
    }

    @RequestMapping(value = "/noticeUpdate.do", method = RequestMethod.POST)
    public String noticeUpdate(@ModelAttribute ArticleDataVO articleDataVO,
                                @PathVariable("path") String path,
                                @RequestParam Map<String, Object> commandMap,
                                MultipartHttpServletRequest multiRequest,
                                HttpServletRequest request,
    ...
    public String noticeDelete(@ModelAttribute ArticleDataVO articleDataVO, HttpServletRequest request,
                                @PathVariable("path") String path,
                                @RequestParam Map<String, Object> commandMap,
                                ModelMap model) throws Exception
    {
        ...
        BbsViewerLogVO bbsViewerLogVO = new BbsViewerLogVO();
        bbsViewerLogVO.setNttId(articleDataVO.getNttId());

        articleDataService.deleteBbsViewer(bbsViewerLogVO);
