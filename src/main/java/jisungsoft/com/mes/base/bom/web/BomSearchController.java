...
@Slf4j
@Controller
@RequestMapping("/mes/base/bom/search")
public class BomSearchController {
    ...
    private final String VIEW_PATH = "jisungsoft/com/mes/base/bom/search";
    private final String REDIRECT_PATH = "redirect:/mes/base/bom/search";

    /**
     * Redirect Validation form
     * @return
     */
    @ModelAttribute("bomSearchForm")
    public Bom newForm() {
        Bom bom = new Bom();
    ...
    public String list(@ModelAttribute("searchForm") Bom searchForm,
    ...
    public String addAction(@Validated @ModelAttribute("bomSearchForm") Bom form,
    ...
    public String editAction(@Validated @ModelAttribute("bomSearchForm") Bom form,
                             final BindingResult bindingResult, Locale locale,
                             final RedirectAttributes attr) {
    ...
    public String removeAction(@Validated @ModelAttribute("bomSearchForm") Bom form,
