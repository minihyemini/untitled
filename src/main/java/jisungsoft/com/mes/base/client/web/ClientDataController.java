package jisungsoft.com.mes.base.client.web;
...
public class ClientDataController {
    ...
    private final String VIEW_PATH = "jisungsoft/com/mes/base/client";
    private final String REDIRECT_PATH = "redirect:/mes/base/client";

    @ModelAttribute("clientForm")
    public Client newClientForm() {
        return new Client();
    }
    ...
    public String addAction(@Validated @ModelAttribute("clientForm") Client form,
        ...
        try {
            ...
            clientService.addClientData(form);
    ...
    public String editAction(@Validated @ModelAttribute("clientForm") Client form,
        ...
        try {
            ...
            clientService.editClientData(form);
    ...
    public String removeAction(@Validated @ModelAttribute("clientForm") Client form, Locale locale,
        ...
        try {
            clientService.removeClientData(form);
