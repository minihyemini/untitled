package jisungsoft.com.mes.base.process.master.web;
...
public class ProcessMasterController {
    ...
    /** processCodeIdGnrService */
    @Resource(name="processCodeIdGnrService")
    private EgovIdGnrService idgenService;

    private final String VIEW_PATH = "jisungsoft/com/mes/base/process/master";
    ...
    public String addAction(@Validated @ModelAttribute("detailCodeForm") CmmnDetailCode form,
        ...
        if (bindingResult.hasErrors()) {
            ...
            return "redirect:/mes/base/process/master/list.do";
        }
