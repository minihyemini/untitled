package jisungsoft.com.mes.fld.mat.pts.web;
...
@Slf4j
@Controller
@RequestMapping("/mes/fld/mat/pts")
public class ProcessTransferStatementController {
    @Autowired
    ...
    private final String VIEW_PATH = "jisungsoft/com/mes/fld/mat/pts";
    private final String REDIRECT_PATH = "redirect:/mes/fld/mat/pts";

    /**
     * Redirect Validation form
     * @return
     */
    @ModelAttribute("ptsForm")
    public Material newPtsForm() {
        Material material = new Material();
        return material;
    }

    @RequestMapping(value = "/list.do", method = {RequestMethod.POST, RequestMethod.GET})
    public String list(Material searchForm, final Model model, Locale locale, HttpServletRequest request) {
    ...
    public String addAction(@Validated final BindingResult bindingResult, Locale locale, final RedirectAttributes attr) {
    ...
    @RequestMapping("/printView.do")
    public String printView() {

        return VIEW_PATH + "/printView";
    }
}
