package jisungsoft.com.mes.fld.mat.web;
...
@Slf4j
@Controller
@RequestMapping("/mes/fld/mat")
public class FldMatController {
    ...
    private final String VIEW_PATH = "jisungsoft/com/mes/fld/mat";
    private final String REDIRECT_PATH = "redirect:/mes/fld/mat";

    /**
     * Redirect Validation form
     * @return
     */
    @ModelAttribute("fldMatForm")
    public Material newfldMatForm() {
