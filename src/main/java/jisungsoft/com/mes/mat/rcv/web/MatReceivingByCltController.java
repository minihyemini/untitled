package jisungsoft.com.mes.mat.rcv.web;
...
@Slf4j
@Controller
@RequestMapping(value = "/mes/mat/rcv/clt")
public class MatReceivingByCltController {
    ...
    private final String VIEW_PATH = "jisungsoft/com/mes/mat/rcv/clt";
    private final String REDIRECT_PATH = "redirect:/mes/mat/rcv/clt";

    /**
     * Redirect Validation form
     * @return
     */
    @ModelAttribute("matReceivingForm")
    public Material newMatReceivingForm() {
    ...
    public String addAction(@Validated @ModelAttribute("matReceivingForm") Material form,
        ...
        if (bindingResult.hasErrors()) {
            ...
            attr.addFlashAttribute(BindingResult.MODEL_KEY_PREFIX +  "matReceivingForm", bindingResult);
            attr.addFlashAttribute("matReceivingForm", form);
    ...
    public String editAction(@Validated @ModelAttribute("matReceivingForm") Material form, final BindingResult bindingResult, Locale locale,
