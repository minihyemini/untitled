...
@Slf4j
@Controller
@RequestMapping(value = "/mes/mat/rcv/dt")
public class MatReceivingByDtController {
    ...
    private final String VIEW_PATH = "jisungsoft/com/mes/mat/rcv/dt";
    private final String REDIRECT_PATH = "redirect:/mes/mat/rcv/dt";
