...
@Slf4j
@Controller
@RequestMapping(value = "/mes/mat/rcv/pd")
public class MatReceivingByPdController {
    ...
    private final String VIEW_PATH = "jisungsoft/com/mes/mat/rcv/pd";
    private final String REDIRECT_PATH = "redirect:/mes/mat/rcv/pd";
