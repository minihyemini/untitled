...
@Slf4j
@Controller
@RequestMapping(value = "/mes/mat/rcv")
public class MatReceivingController {
    ...
    private final String VIEW_PATH = "jisungsoft/com/mes/mat/rcv";
    private final String REDIRECT_PATH = "redirect:/mes/mat/rcv";
