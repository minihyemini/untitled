...
@Slf4j
@Controller
@RequestMapping(value = "/mes/mat/shp/dt")
public class MatShppingByDtController {
    ...
    private final String VIEW_PATH = "jisungsoft/com/mes/mat/shp/dt";
    private final String REDIRECT_PATH = "redirect:/mes/mat/shp/dt";
