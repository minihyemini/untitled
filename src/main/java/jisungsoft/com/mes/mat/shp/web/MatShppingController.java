...
@Slf4j
@Controller
@RequestMapping(value = "/mes/mat/shp")
public class MatShppingController {
    ...
    private final String VIEW_PATH = "jisungsoft/com/mes/mat/shp";
    private final String REDIRECT_PATH = "redirect:/mes/mat/shp";
