package jisungsoft.com.mes.prdc.rcd.web;

import egovframework.com.cmm.EgovMessageSource;
import egovframework.rte.fdl.access.service.EgovUserDetailsHelper;
import jisungsoft.com.persistence.dto.mes.Pdperformce;
...
@Slf4j
@Controller
@RequestMapping(value = "/mes/prdc/rcd")
public class PrdcRecordController {
    ...
    private final String VIEW_PATH = "jisungsoft/com/mes/prdc/rcd";
    private final String REDIRECT_PATH = "/mes/prdc/rcd";

    /**
     * Redirect Validation form
     * @return
     */
    @ModelAttribute("PdperformceForm")
    public Pdperformce newPdperformForm() {
        return new Pdperformce();
    }

    @RequestMapping(value = "/list.do", method = {RequestMethod.POST, RequestMethod.GET})
    public String list(Pdperformce searchForm, final Model model, Locale locale, HttpServletRequest request) {
