package jisungsoft.com.mes.qlt.iqc.web;
...
/**
 * Field import inspection
 * 수입검사
 */
@Slf4j
@Controller
@RequestMapping("/mes/qlt/iqc")
public class QltReceivingInspectionController {
    ...
    private final String VIEW_PATH = "jisungsoft/com/mes/qlt/iqc";
    private final String REDIRECT_PATH = "redirect:/mes/qlt/iqc";
