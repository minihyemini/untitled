package jisungsoft.com.mes.qlt.mcn.mng.web;
...
import jisungsoft.com.persistence.dto.mes.Machine;
...
@Slf4j
@Controller
@RequestMapping("/mes/qlt/mcn/mng")
public class QltMachineDataController {
    ...
    private final String VIEW_PATH = "jisungsoft/com/mes/qlt/mcn/mng";
    private final String REDIRECT_PATH = "redirect:/mes/qlt/mcn/mng";

    /**
     * Redirect Validation form
     * @return
     */
    @ModelAttribute("qltMachineForm")
    public Machine newQltMachineForm() {
    ...
    public String list(@ModelAttribute("searchForm") Machine searchForm, final Model model, Locale locale, HttpServletRequest request) {
    ...
    public String addAction(@Validated @ModelAttribute("qltMachineForm") Machine form, final BindingResult bindingResult, Locale locale,
        ...
        if (bindingResult.hasErrors()) {
            ...
            attr.addFlashAttribute(BindingResult.MODEL_KEY_PREFIX +  "qltMachineForm", bindingResult);
            attr.addFlashAttribute("qltMachineForm", form);
    ...
    public String editAction(@Validated @ModelAttribute("qltMachineForm") Machine form, final BindingResult bindingResult, Locale locale,
                             final RedirectAttributes attr) {
    ...
    public String removeAction(@Validated @ModelAttribute("qltMachineForm") Machine form,
