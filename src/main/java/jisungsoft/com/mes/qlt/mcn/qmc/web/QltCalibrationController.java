package jisungsoft.com.mes.qlt.mcn.qmc.web;
...
@Slf4j
@Controller
@RequestMapping("/mes/qlt/mcn/qmc")
public class QltCalibrationController {
    ...
    private final String VIEW_PATH = "jisungsoft/com/mes/qlt/mcn/qmc";
     ...
     * @return
     */
    @ModelAttribute("qltCalibrationForm")
    ...
    public String list(@ModelAttribute("searchForm") Machine searchForm,
    ...
    public String addAction(@Validated @ModelAttribute("qltCalibrationForm") Machine form, final BindingResult bindingResult, Locale locale,
        ...
        if (bindingResult.hasErrors()) {
            ...
            attr.addFlashAttribute(BindingResult.MODEL_KEY_PREFIX +  "qltCalibrationForm", bindingResult);
    ...
    public String editAction(@Validated @ModelAttribute("qltCalibrationForm") Machine form, final BindingResult bindingResult, Locale locale,
                             final RedirectAttributes attr) {
    ...
    public String removeAction(@Validated @ModelAttribute("qltCalibrationForm") Machine form,
