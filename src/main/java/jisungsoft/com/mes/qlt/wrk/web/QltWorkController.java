package jisungsoft.com.mes.qlt.wrk.web;
...
@Slf4j
@Controller
@RequestMapping("/mes/qlt/wrk")
public class QltWorkController {
    ...
    private final String VIEW_PATH = "jisungsoft/com/mes/qlt/wrk";
    private final String REDIRECT_PATH = "/mes/qlt/wrk";

    /**
     * Redirect Validation form
     * @return
     */
    @ModelAttribute("receivingInspectionForm")
    public RcvIspInfo newReceivingInspectionForm() {
        RcvIspInfo rcvIspInfo = new RcvIspInfo();
    ...
    public String addAction(@Validated @ModelAttribute("receivingInspectionForm") RcvIspInfo form, final BindingResult bindingResult, Locale locale,
    ...
    public String editAction(@Validated @ModelAttribute("receivingInspectionForm") RcvIspInfo form, final BindingResult bindingResult, Locale locale,
                             final RedirectAttributes attr) {
