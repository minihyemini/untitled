package jisungsoft.com.mes.sales.cls.web;

import egovframework.com.cmm.EgovMessageSource;
import egovframework.rte.fdl.access.service.EgovUserDetailsHelper;
import jisungsoft.com.persistence.dto.mes.SalesClose;
...
@Slf4j
@Controller
@RequestMapping(value = "/mes/sales/cls")
public class SalesCloseController {
    ...
    private final String VIEW_PATH = "jisungsoft/com/mes/sales/cls";
    private final String REDIRECT_PATH = "redirect:/mes/sales/cls";

    /**
     * Redirect Validation form
     * @return
     */
    @ModelAttribute("salesCloseForm")
    public SalesClose newSalesCloseForm() {
        return new SalesClose();
    }
    ...
    public String list(Sles searchForm, final Model model, Locale locale, HttpServletRequest request) {
    ...
    public String addAction(final BindingResult bindingResult, Locale locale, final RedirectAttributes attr) {
    ...
    public String removeAction(@Validated final BindingResult bindingResult, Model model, Locale locale,
                               final RedirectAttributes attr) {
