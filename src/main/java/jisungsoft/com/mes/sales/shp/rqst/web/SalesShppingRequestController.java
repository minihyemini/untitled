package jisungsoft.com.mes.sales.shp.rqst.web;
...
@Slf4j
@Controller
@RequestMapping(value = "/mes/sales/rqst")
public class SalesShppingRequestController {
    ...
    private final String VIEW_PATH = "jisungsoft/com/mes/sales/rqst";
    private final String REDIRECT_PATH = "/mes/sales/rqst";
