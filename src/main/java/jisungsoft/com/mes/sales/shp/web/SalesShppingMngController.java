package jisungsoft.com.mes.sales.shp.web;

import egovframework.com.cmm.EgovMessageSource;
import egovframework.rte.fdl.access.service.EgovUserDetailsHelper;
import jisungsoft.com.persistence.dto.mes.SalesShipping;
...
@Slf4j
@Controller
@RequestMapping(value = "/mes/sales/shp")
public class SalesShppingMngController {
    ...
    private final String VIEW_PATH = "jisungsoft/com/mes/sales/shp";
    private final String REDIRECT_PATH = "/mes/sales/shp";

    /**
     * Redirect Validation form
     * @return
     */
    @ModelAttribute("salesShippingForm")
    public SalesShipping newSalesShippingForm() {
        return new SalesShipping();
    }

    @RequestMapping(value = "/list.do", method = {RequestMethod.POST, RequestMethod.GET})
    public String list(SalesShipping searchForm, final Model model, Locale locale, HttpServletRequest request) {
