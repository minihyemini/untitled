package jisungsoft.com.mes.sales.sot.web;

import egovframework.com.cmm.EgovMessageSource;
import egovframework.rte.fdl.access.service.EgovUserDetailsHelper;
import jisungsoft.com.persistence.dto.mes.SalesSOT;
...
@Slf4j
@Controller
@RequestMapping(value = "/mes/sales/sot")
public class SalesSOTController {
    ...
    private final String VIEW_PATH = "jisungsoft/com/mes/sales/sot";
    private final String REDIRECT_PATH = "/mes/sales/sot";

    /**
     * Redirect Validation form
     * @return
     */
    @ModelAttribute("salesSOTForm")
    public SalesSOT newSalesSOTForm() {
        return new SalesSOT();
    }
