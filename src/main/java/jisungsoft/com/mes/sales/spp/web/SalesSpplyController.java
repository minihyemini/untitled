package jisungsoft.com.mes.sales.spp.web;
...
@Slf4j
@Controller
@RequestMapping("/mes/sales/spp")
public class SalesSpplyController {
    ...
    public String list(final Model model, Locale locale, HttpServletRequest request) {
