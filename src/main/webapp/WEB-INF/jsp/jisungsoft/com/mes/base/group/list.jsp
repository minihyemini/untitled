...
<div class="row">
    <div class="col-xl-12">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <h2><spring:message code="group.title"/></h2>
                <div class="float-right m-2">
                    <button type="button" class="btn btn-secondary waves-effect waves-themed" onclick="fn_reset('groupForm');">
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    <%--@elvariable id="searchForm" type="jisungsoft.com.persistence.dto.sec.Group"--%>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-2 input-group input-group-sm">
                                <form:select path="searchCondition" cssClass="form-control">
                                    ...
                                    <form:option value="1"><spring:message code="group.id"/></form:option>
                                    <form:option value="2"><spring:message code="group.name"/></form:option>
                                </form:select>
                            </div>
                        </div>
                    </form:form>
...
<div class="row">
    <div class="col-xl-6">
        <div id="panel-2" class="panel">
            <div class="panel-container show">
                <div class="panel-content">
                    <!-- datatable start -->
                    <table id="dt-group" class="table table-bordered table-hover table-striped table-sm">
                        <thead class="thead-dark">
                        <tr>
                            <th>NO</th>
                            <th><spring:message code="group.id"/></th>
                            <th><spring:message code="group.name"/></th>
                            <th><spring:message code="group.desc"/></th>
                        </tr>
                        </thead>
                        <tbody>
                        <c:forEach var="result" items="${resultList}" varStatus="status">
                            <tr data-id="${result.groupId}">
    ...
    <%@include file="/WEB-INF/jsp/jisungsoft/com/mes/base/group/form.jsp"%>
</div>
<%--//그룹 데이터--%>