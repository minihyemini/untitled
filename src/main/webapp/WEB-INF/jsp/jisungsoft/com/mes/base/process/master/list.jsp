...
<%@include file="/WEB-INF/jsp/jisungsoft/com/mes/base/process/master/searchForm.jsp"%>
<%-- 테이블 데이터--%>
<div class="row">
    <div class="col-xl-12">
                        ...
                        <div class="col-sm-12">
                            <table id="dt-basic" class="table table-bordered table-hover table-striped w-100 dataTable table-sm">
                                ...
                                <tr>
                                    ...
                                    <th><spring:message code="process.master.name"/></th>
...
<%@ include file="/WEB-INF/jsp/jisungsoft/com/mes/base/process/master/form.jsp"%>
