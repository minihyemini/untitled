...
<%@include file="/WEB-INF/jsp/jisungsoft/com/mes/base/process/routing/searchForm.jsp"%>
<%-- 테이블 데이터--%>
<div class="row">
    <div class="col-xl-12">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <table id="dt-basic" class="table table-bordered table-hover table-striped w-100 dataTable table-sm">
                                ...
                                <tr>
                                    <th><spring:message code="process.routing.code"/></th>
                                    <th><spring:message code="process.routing.name"/></th>
...
<%@ include file="/WEB-INF/jsp/jisungsoft/com/mes/base/process/routing/form.jsp"%>
