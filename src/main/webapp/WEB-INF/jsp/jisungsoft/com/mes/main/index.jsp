        ...
        <div class="p-3 bg-primary-300 rounded overflow-hidden position-relative text-white mb-g">
            <div class="">
                <h3 class="display-4 d-block l-h-n m-0 fw-500">
                    6
                    <small class="m-0 l-h-n">설비대수</small>
                </h3>
            </div>
    ...
    <div class="col-sm-6 col-xl-3">
        <div class="p-3 bg-success-400 rounded overflow-hidden position-relative text-white mb-g">
            <div class="">
                <h3 class="display-4 d-block l-h-n m-0 fw-500">
                    5
                    <small class="m-0 l-h-n">가동대수</small>
                </h3>
            </div>
            <i class="fal fa-lightbulb position-absolute pos-right pos-bottom opacity-15 mb-n5 mr-n6" style="font-size: 6rem;"></i>
        </div>
    ...
    <div class="col-sm-6 col-xl-3">
        <div class="p-3 bg-danger-200 rounded overflow-hidden position-relative text-white mb-g">
            <div class="">
                <h3 class="display-4 d-block l-h-n m-0 fw-500">
                    1
                    <small class="m-0 l-h-n">비가동대수</small>
                </h3>
            </div>
            <i class="fal fa-lightbulb position-absolute pos-right pos-bottom opacity-15 mb-n5 mr-n6" style="font-size: 6rem;"></i>
        </div>
    ...
    <div class="col-sm-6 col-xl-3">
        <div class="p-3 bg-info-200 rounded overflow-hidden position-relative text-white mb-g">
            <div class="">
                <h3 class="display-4 d-block l-h-n m-0 fw-500">
                    70%
                    <small class="m-0 l-h-n">설비가동률</small>
                </h3>
            </div>
            <i class="fal fa-lightbulb position-absolute pos-right pos-bottom opacity-15 mb-n5 mr-n6" style="font-size: 6rem;"></i>
        </div>
        ...
        <div id="panel-9" class="panel">
            ...
            <div class="panel-container show">
                <div class="card-columns">
                    <div class="card">
                        <div class="w-100 bg-fusion-300 bg-success" style="padding:10px 0 10px 0;">
                            <div class="text-center">
                                사출1호기<br>
                                0001HG<br>
                                512/2000&nbsp;<div id="f1"></div>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="js-progress-animated">
                                <div class="progress progress-xl">
                                    <div class="progress-bar progress-bar-striped bg-success-500" role="progressbar" style="width: 60%" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100">
                                        60%
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card">
                        <div class="w-100 bg-fusion-300 bg-warning" style="padding:10px 0 10px 0;">
                            <div class="text-center">
                                사출4호기<br>
                                0001HG<br>
                                512/2000&nbsp;<div id="f4"></div>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="js-progress-animated">
                                <div class="progress progress-xl">
                                    <div class="progress-bar progress-bar-striped bg-warning-500" role="progressbar" style="width: 60%" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100">
                                        60%
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card">
                        <div class="w-100 bg-fusion-300 bg-danger" style="padding:10px 0 10px 0;">
                            <div class="text-center">
                                사출5호기<br>
                                0001HG<br>
                                512/2000&nbsp;<div id="f5"></div>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="js-progress-animated">
                                <div class="progress progress-xl">
                                    <div class="progress-bar progress-bar-striped bg-primary-500" role="progressbar" style="width: 0%" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100">
                                        0%
                                    </div>
                                </div>
                            </div>
