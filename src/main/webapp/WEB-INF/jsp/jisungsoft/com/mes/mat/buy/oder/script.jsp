...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#dt-basic tbody').on('click', 'tr', function(event) {
            ...
            $.ajax({
                type:"post",
                async:false,
                url:"<c:url value='/mes/mat/buy/ordr/item/list.json'/>",
                ...
                success:function (result){
                    ...
                    $form.ordDuedate.value = detail.ordDuedate;
    ...
    function fn_getPage(obj) {
        ...
        if (target == 'search') {
            ...
            $form.action = '<c:url value='/mes/mat/buy/ordr/list.do'/>';
        }
    ...
    function fn_dataAction(obj) {
        ...
        if (target == 'save') {
            if (isEmpty(id)) {
                $form.action = '<c:url value='/mes/mat/buy/ordr/add.do'/>';
            } else {
                $form.action = '<c:url value='/mes/mat/buy/ordr/edit.do'/>';
            }
            $form.submit();
            ...
            $.ajax({
                type:"post",
                async:false,
                url:"<c:url value='/mes/mat/buy/ordr/item/remove.json'/>",
                data:$formData,
                dataType:'json',
                success:function (result){
    ...
    function fn_getClientData(obj) {
        ...
        $.ajax({
            type:"post",
            async:false,
            url:"<c:url value='/mes/mat/buy/ordr/client/list.json'/>",
            data:$form,
            dataType:'json',
            success:function (result){
                let dataList = result.dataList;
