...
<%@include file="/WEB-INF/jsp/jisungsoft/com/mes/sales/rod/searchForm.jsp" %>
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    <table id="dt-basic" class="table table-bordered table-hover table-striped w-100 dataTable table-sm">
                        ...
                        <tr>
                            <th><spring:message code="sales.receive.order.salesNum"/></th>
                            <th><spring:message code="sales.receive.order.clientName"/></th>
<%--                            <th><spring:message code="sales.receive.order.category"/></th>--%>
                            <th><spring:message code="sales.receive.order.orderDate"/></th>
                            <th><spring:message code="sales.receive.order.salesDate"/></th>
                            ...
                            <th><spring:message code="sales.receive.order.salesTotal"/></th>
                            <th><spring:message code="sales.receive.order.registrationDate"/></th>
                            ...
                            <th><spring:message code="sales.receive.order.description"/></th>
                        </tr>
                        </thead>
                        <tbody>
...
<%--                                <td><c:out value="${result.ordCategoryNm}"/></td>--%>
                                ...
                                <td><c:out value="${result.ordDlvrschdt}"/></td>
...
<%@include file="/WEB-INF/jsp/jisungsoft/com/mes/sales/rod/form.jsp" %>