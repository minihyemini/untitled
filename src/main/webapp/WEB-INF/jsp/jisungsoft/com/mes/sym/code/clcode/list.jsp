...
<%@include file="/WEB-INF/jsp/jisungsoft/com/mes/sym/code/clcode/searchForm.jsp"%>
<%-- 테이블 데이터--%>
<div class="row">
    <div class="col-xl-12">
                                ...
                                <c:choose>
                                    <c:when test="${fn:length(resultList) > 0}">
                                        <c:forEach var="result" items="${resultList}" varStatus="status">
                                            <tr onclick="fn_getEditFormData(this);" data-id="${result.clCode}">
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-xs btn-danger waves-effect waves-themed" data-toggle="modal" data-target="#remove-modal-alert" onclick="fn_getEditFormData(this);" data-id="${result.clCode}">
...
<%-- //테이블 데이터--%>
<%@include file="/WEB-INF/jsp/jisungsoft/com/mes/sym/code/clcode/editForm.jsp"%>
