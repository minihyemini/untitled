...
<div class="row">
    <div class="col-xl-12">
        <div id="panel-2" class="panel">
            <div class="panel-hdr">
                <h2><spring:message code="clcode.title"/></h2>
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    <%--@elvariable id="cmmnClCode" type="jisungsoft.com.persistence.dto.sym.code.CmmnClCode"--%>
                    <form:form commandName="cmmnClCode" name="searchForm" class="needs-validation" method="post">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-2 mb-3">
                                    ...
                                    <form:select path="searchCondition" cssClass="form-control">
                                        ...
                                        <form:option value="1"><spring:message code="clcode.id"/></form:option>
                                        <form:option value="2"><spring:message code="clcode.name"/></form:option>
                                    </form:select>
                                </div>
                                <div class="col-md-1 mb-3">
                                    <form:label path="useAt" cssClass="form-label"><spring:message code="clcode.useat"/></form:label>
