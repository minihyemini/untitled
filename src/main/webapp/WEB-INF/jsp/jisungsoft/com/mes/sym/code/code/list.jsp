...
<%@include file="/WEB-INF/jsp/jisungsoft/com/mes/sym/code/code/searchForm.jsp"%>
<%-- 테이블 데이터--%>
<div class="row">
    <div class="col-xl-12">
                                ...
                                <c:choose>
                                    <c:when test="${fn:length(resultList) > 0}">
                                        <c:forEach var="result" items="${resultList}" varStatus="status">
                                            <tr onclick="fn_getEditFormData(this);" data-id="${result.codeId}">
...
<%@ include file="/WEB-INF/jsp/jisungsoft/com/mes/sym/code/code/editForm.jsp"%>
