...
<div class="row">
    <div class="col-xl-12">
        <div id="panel-2" class="panel">
            <div class="panel-hdr">
                <h2><spring:message code="detailCode.title"/></h2>
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    <%--@elvariable id="cmmnDetailCode" type="jisungsoft.com.persistence.dto.sym.code.CmmnDetailCode"--%>
                    <form:form commandName="cmmnDetailCode" name="searchForm" class="needs-validation" method="post">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-2 mb-3">
                                    ...
                                    <form:select path="searchCondition" cssClass="form-control">
                                        ...
                                        <form:option value="3"><spring:message code="detailCode.id"/></form:option>
                                        <form:option value="4"><spring:message code="detailCode.name"/></form:option>
                                    </form:select>
                                </div>
